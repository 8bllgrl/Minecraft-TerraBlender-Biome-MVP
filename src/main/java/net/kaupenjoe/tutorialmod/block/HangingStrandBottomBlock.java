...
public class HangingStrandBottomBlock extends GrowingPlantHeadBlock
{
    ...
    public boolean canSurvive(BlockState p_196260_1_, LevelReader p_196260_2_, BlockPos p_196260_3_) {
        ...
        if (!this.canAttachTo(blockstate)) {
            ...
            return block == this.getHeadBlock() || block == this.getBodyBlock() || (blockstate.is(BlockTags.DRIPSTONE_REPLACEABLE) && blockstate.isFaceSturdy(p_196260_2_, blockpos, Direction.DOWN));
        }
    }
